  ...
  return (
    <div>
        ...
        <div className="form-div">
          ...
          <input type="tel" className="form-input" id="aadhar_number" placeholder="5416-5967-1111"/>
          <span className="help-block"></span>
        </div>
        ...
        <div className="form-div">
          ...
          <select id="marital" name="marital" required className='form-input'>
          <option value="Male">Male</option>
          <option value="Female">Female</option>
          <option value="Other">Other</option>
        </select>
        ...
        onChange={(e) => {
         ...
         id="state" name="state" required className='form-input'>
        ...
        <div className="form-div">
          ...
          <select  id="district" name="district" required className='form-input'>
        {countries[country] &&
        ...
        <div className="form-div">
          ...
          <input type="text" className="form-input" id="Taluka" placeholder="Taluka" required autofocus autocomplete="on"/>
          <span className="help-block"></span>
        </div>

        <div className="form-div">
          <label for="Pincode">Pincode</label>
          <input type="tel" className="form-input" id="Pincode" placeholder="Pincode" required autofocus autocomplete="on"/>
          <span className="help-block"></span>
        </div>
        ...
        <button className="full-width-btn form-input" type="submit">Confirm Appointment</button>
      </form>
    </div>
  )
}
